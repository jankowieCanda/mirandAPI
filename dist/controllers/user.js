...
exports.userRouter.post('/users', auth_1.auth, (req, res) => {
    res.send('USER POST');
});
exports.userRouter.patch('/users/:id', auth_1.auth, (req, res) => {
    res.send('USER PATCH INDIVIDUAL');
});
exports.userRouter.delete('/users/:id', auth_1.auth, (req, res) => {
