...
describe('GET /rooms', () => {
    test('should get allRooms', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should get one room with Room_ID', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield request(app_1.app)
            .get('/rooms/7')
            .set('Authorization', `Bearer ${token}`)
            .expect(200)
    ...
    test('should throw error room not found', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield request(app_1.app)
            .get('/rooms/25')
            .set('Authorization', `Bearer ${token}`)
